...
Here is the customer list.. create a table for this.. 
...
and here is the category details for the sales module.. create a table for this where you maintain the category and subcategory as it is.. means the subcategory in comma separated format.. 
